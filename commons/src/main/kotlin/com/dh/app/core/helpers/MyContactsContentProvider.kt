...
import com.dh.app.core.extensions.getIntValue
import com.dh.app.core.extensions.getStringValue
...
import com.dh.app.core.models.contacts.Contact
 ...
 class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.dh.app.core.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.dh.phone" && packageName != "com.dh.messages" && packageName != "com.dh.calendar") {
                return contacts
            }
