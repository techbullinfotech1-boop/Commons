...
import com.dh.app.core.helpers.AppLockManager
import com.dh.app.core.helpers.BaseConfig
import com.dh.app.core.helpers.ContactsHelper
import com.dh.app.core.helpers.DAY_SECONDS
import com.dh.app.core.helpers.FONT_SIZE_LARGE
import com.dh.app.core.helpers.FONT_SIZE_MEDIUM
import com.dh.app.core.helpers.FONT_SIZE_SMALL
import com.dh.app.core.helpers.FRIDAY_BIT
import com.dh.app.core.helpers.HOUR_SECONDS
import com.dh.app.core.helpers.KEY_MAILTO
import com.dh.app.core.helpers.MINUTE_SECONDS
import com.dh.app.core.helpers.MONDAY_BIT
import com.dh.app.core.helpers.MONTH_SECONDS
import com.dh.app.core.helpers.MyContactsContentProvider
import com.dh.app.core.helpers.MyContentProvider
import com.dh.app.core.helpers.MyContentProvider.PERMISSION_WRITE_GLOBAL_SETTINGS
import com.dh.app.core.helpers.PERMISSION_ACCESS_COARSE_LOCATION
import com.dh.app.core.helpers.PERMISSION_ACCESS_FINE_LOCATION
import com.dh.app.core.helpers.PERMISSION_CALL_PHONE
import com.dh.app.core.helpers.PERMISSION_CAMERA
import com.dh.app.core.helpers.PERMISSION_GET_ACCOUNTS
import com.dh.app.core.helpers.PERMISSION_MEDIA_LOCATION
import com.dh.app.core.helpers.PERMISSION_POST_NOTIFICATIONS
import com.dh.app.core.helpers.PERMISSION_READ_CALENDAR
import com.dh.app.core.helpers.PERMISSION_READ_CALL_LOG
import com.dh.app.core.helpers.PERMISSION_READ_CONTACTS
import com.dh.app.core.helpers.PERMISSION_READ_MEDIA_AUDIO
import com.dh.app.core.helpers.PERMISSION_READ_MEDIA_IMAGES
import com.dh.app.core.helpers.PERMISSION_READ_MEDIA_VIDEO
import com.dh.app.core.helpers.PERMISSION_READ_MEDIA_VISUAL_USER_SELECTED
import com.dh.app.core.helpers.PERMISSION_READ_PHONE_STATE
import com.dh.app.core.helpers.PERMISSION_READ_SMS
import com.dh.app.core.helpers.PERMISSION_READ_STORAGE
import com.dh.app.core.helpers.PERMISSION_READ_SYNC_SETTINGS
import com.dh.app.core.helpers.PERMISSION_RECORD_AUDIO
import com.dh.app.core.helpers.PERMISSION_SEND_SMS
import com.dh.app.core.helpers.PERMISSION_WRITE_CALENDAR
import com.dh.app.core.helpers.PERMISSION_WRITE_CALL_LOG
import com.dh.app.core.helpers.PERMISSION_WRITE_CONTACTS
import com.dh.app.core.helpers.PERMISSION_WRITE_STORAGE
import com.dh.app.core.helpers.PREFS_KEY
import com.dh.app.core.helpers.SATURDAY_BIT
import com.dh.app.core.helpers.SUNDAY_BIT
import com.dh.app.core.helpers.THURSDAY_BIT
import com.dh.app.core.helpers.TIME_FORMAT_12
import com.dh.app.core.helpers.TIME_FORMAT_12_WITH_SECS
import com.dh.app.core.helpers.TIME_FORMAT_24
import com.dh.app.core.helpers.TIME_FORMAT_24_WITH_SECS
import com.dh.app.core.helpers.TUESDAY_BIT
import com.dh.app.core.helpers.WEDNESDAY_BIT
import com.dh.app.core.helpers.WEEK_SECONDS
import com.dh.app.core.helpers.YEAR_SECONDS
import com.dh.app.core.helpers.YOUR_ALARM_SOUNDS_MIN_ID
import com.dh.app.core.helpers.ensureBackgroundThread
import com.dh.app.core.helpers.isNougatPlus
import com.dh.app.core.helpers.isOnMainThread
import com.dh.app.core.helpers.isQPlus
import com.dh.app.core.helpers.isRPlus
import com.dh.app.core.helpers.isSPlus
import com.dh.app.core.helpers.isUpsideDownCakePlus
import com.dh.app.core.helpers.proPackages
import com.dh.app.core.models.AlarmSound
import com.dh.app.core.models.BlockedNumber
...
import com.dh.app.core.helpers.FontHelper
import com.dh.app.core.helpers.FossifyThankYou
import com.dh.app.core.helpers.isPiePlus
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.dh.contacts") && !packageName.startsWith("com.dh.phone")) {
        true
    } else if ((packageName.startsWith("com.dh.contacts") || packageName.startsWith("com.dh.phone")) && isQPlus()) {
