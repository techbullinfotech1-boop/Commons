...
import com.dh.app.core.compose.extensions.onEventValue
import com.dh.app.core.compose.screens.ManageBlockedNumbersScreen
import com.dh.app.core.compose.theme.AppThemeSurface
import com.dh.app.core.dialogs.AddOrEditBlockedNumberAlertDialog
import com.dh.app.core.dialogs.ExportBlockedNumbersDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.dh.phone")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.dh.phone")) {
