package com.dh.commons.asynctasks
...
import com.dh.commons.helpers.getConflictResolution
import com.dh.commons.helpers.isOreoPlus
import com.dh.commons.interfaces.CopyMoveListener
...
class CopyMoveTask(
    ...
    private var mFileDirItemsToDelete = ArrayList<FileDirItem>()
