...
import com.dh.commons.helpers.AppLockManager
import com.dh.commons.helpers.BaseConfig
import com.dh.commons.helpers.ContactsHelper
import com.dh.commons.helpers.DAY_SECONDS
import com.dh.commons.helpers.FONT_SIZE_LARGE
import com.dh.commons.helpers.FONT_SIZE_MEDIUM
import com.dh.commons.helpers.FONT_SIZE_SMALL
import com.dh.commons.helpers.FRIDAY_BIT
import com.dh.commons.helpers.HOUR_SECONDS
import com.dh.commons.helpers.KEY_MAILTO
import com.dh.commons.helpers.MINUTE_SECONDS
import com.dh.commons.helpers.MONDAY_BIT
import com.dh.commons.helpers.MONTH_SECONDS
import com.dh.commons.helpers.MyContactsContentProvider
import com.dh.commons.helpers.MyContentProvider
import com.dh.commons.helpers.MyContentProvider.PERMISSION_WRITE_GLOBAL_SETTINGS
import com.dh.commons.helpers.PERMISSION_ACCESS_COARSE_LOCATION
import com.dh.commons.helpers.PERMISSION_ACCESS_FINE_LOCATION
import com.dh.commons.helpers.PERMISSION_CALL_PHONE
import com.dh.commons.helpers.PERMISSION_CAMERA
import com.dh.commons.helpers.PERMISSION_GET_ACCOUNTS
import com.dh.commons.helpers.PERMISSION_MEDIA_LOCATION
import com.dh.commons.helpers.PERMISSION_POST_NOTIFICATIONS
import com.dh.commons.helpers.PERMISSION_READ_CALENDAR
import com.dh.commons.helpers.PERMISSION_READ_CALL_LOG
import com.dh.commons.helpers.PERMISSION_READ_CONTACTS
import com.dh.commons.helpers.PERMISSION_READ_MEDIA_AUDIO
import com.dh.commons.helpers.PERMISSION_READ_MEDIA_IMAGES
import com.dh.commons.helpers.PERMISSION_READ_MEDIA_VIDEO
import com.dh.commons.helpers.PERMISSION_READ_MEDIA_VISUAL_USER_SELECTED
import com.dh.commons.helpers.PERMISSION_READ_PHONE_STATE
import com.dh.commons.helpers.PERMISSION_READ_SMS
import com.dh.commons.helpers.PERMISSION_READ_STORAGE
import com.dh.commons.helpers.PERMISSION_READ_SYNC_SETTINGS
import com.dh.commons.helpers.PERMISSION_RECORD_AUDIO
import com.dh.commons.helpers.PERMISSION_SEND_SMS
import com.dh.commons.helpers.PERMISSION_WRITE_CALENDAR
import com.dh.commons.helpers.PERMISSION_WRITE_CALL_LOG
import com.dh.commons.helpers.PERMISSION_WRITE_CONTACTS
import com.dh.commons.helpers.PERMISSION_WRITE_STORAGE
import com.dh.commons.helpers.PREFS_KEY
import com.dh.commons.helpers.SATURDAY_BIT
import com.dh.commons.helpers.SUNDAY_BIT
import com.dh.commons.helpers.THURSDAY_BIT
import com.dh.commons.helpers.TIME_FORMAT_12
import com.dh.commons.helpers.TIME_FORMAT_12_WITH_SECS
import com.dh.commons.helpers.TIME_FORMAT_24
import com.dh.commons.helpers.TIME_FORMAT_24_WITH_SECS
import com.dh.commons.helpers.TUESDAY_BIT
import com.dh.commons.helpers.WEDNESDAY_BIT
import com.dh.commons.helpers.WEEK_SECONDS
import com.dh.commons.helpers.YEAR_SECONDS
import com.dh.commons.helpers.YOUR_ALARM_SOUNDS_MIN_ID
import com.dh.commons.helpers.ensureBackgroundThread
import com.dh.commons.helpers.isNougatPlus
import com.dh.commons.helpers.isOnMainThread
import com.dh.commons.helpers.isQPlus
import com.dh.commons.helpers.isRPlus
import com.dh.commons.helpers.isSPlus
import com.dh.commons.helpers.isUpsideDownCakePlus
import com.dh.commons.helpers.proPackages
import com.dh.commons.models.AlarmSound
import com.dh.commons.models.BlockedNumber
